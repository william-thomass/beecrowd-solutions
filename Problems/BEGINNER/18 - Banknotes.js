...
let banknotes = parseInt(lines[0])
...
for(let note of notes){
  ...
  let amountNotes = Math.floor(banknotes / note) //Math.floor para pegar o valor inteiro apenas

  console.log(`${amountNotes} nota(s) de R$ ${note},00`)

  banknotes = banknotes % note //or banknotes %= note
}
